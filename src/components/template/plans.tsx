  ...
  return (
    <div className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex flex-col items-center min-h-screen px-4 py-10">
        ...
        {/* Cards */}
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 w-full max-w-4xl">
          {planOptions.map((planOption) => (
            <div
              key={planOption.id}
              className={`relative z-5 group ${theme.cardbackground} rounded-xl  transition-all duration-400 hover:shadow-2xl overflow-hidden`}
            >
              ...
              <div className="p-4 sm:p-4 text-center space-y-5">
                {/* Icono */}
                <div className={`w-20 h-20 mx-auto rounded-full border-3 ${theme.bordercolor} flex items-center justify-center`}>
                ...
                <div className="rounded-xl p-4">
                  <ul className={`space-y-1 ${theme.text} font-bold text-sm sm:text-base`}>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 max-w-sm w-full text-center shadow-2xl space-y-5">
            ...
            <div className="flex flex-col md:flex-row gap-3 justify-center">
              <button
                ...
                className={`w-full md:w-auto flex cursor-pointer items-center justify-center gap-2 px-4 py-2 rounded-lg ${theme.buttoncolor} ${theme.buttontext} hover:${theme.buttonhovercolor} font-medium text-base md:text-sm shadow-lg transition-all duration-300`}
              >
                <CheckCircle size={23} />
                Continuar
              </button>
